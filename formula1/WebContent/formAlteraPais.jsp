    ...
    <div class="container">
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link" href="dashboard.html">Painel<span class="sr-only">(Página atual)</span></a>
            </li>
        </ul>
      </div>
    </div>
...
<div class="container">
	<div class="row mt-5">
		<div class="col-md-12">
			<h1>Alterar País</h1>
<form action="alteraPais" method="get">
Codigo: <input type="hidden" name="codigo" value="${pais.codigo}"><br/><br/>
Nome: <input type="text" name="nome" value="${pais.nome}"><br/><br/>
